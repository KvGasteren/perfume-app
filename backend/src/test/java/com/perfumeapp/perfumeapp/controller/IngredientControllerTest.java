...
public class IngredientControllerTest {
    ...
    void testCreateIngredient() throws Exception {
        ...
        mockMvc.perform(post("/api/ingredients")
                ...
                .andExpect(jsonPath("$.name").value("Rose Oil"));
    ...
    void testAddAllergen() throws Exception {
        when(ingredientService.addAllergen(eq(1L), any(AllergenDTO.class))).thenReturn(sampleIngredient);
        ...
        mockMvc.perform(post("/api/ingredients/1/allergens")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.allergens[0].name").value("Linalool"));

        verify(ingredientService, times(1)).addAllergen(eq(1L), any(AllergenDTO.class));
    }
    ...
    void testUpdateAllergenConcentration() throws Exception {
        ...
        mockMvc.perform(put("/api/ingredients/1/allergens/1")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.allergens[0].concentration").value(0.01));
    ...
    void testGetAllIngredients() throws Exception {
        ...
        mockMvc.perform(get("/api/ingredients"))
                ...
                .andExpect(jsonPath("$[0].name").value("Rose Oil"));
